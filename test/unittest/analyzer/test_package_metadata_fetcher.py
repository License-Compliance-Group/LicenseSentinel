...
from src.license_hierarchy.entities.package_manager_fetcher import AbstractPackageManagerFetcher
from src.license_hierarchy.entities.abstract_dep_tree_builder import AbstractDepTreeBuilder
from src.license_hierarchy.entities.abstract_repo_downloader import AbstractRepoDownloader
...
class TestPackageMetadataFetcherBuild:
    ...
    def test_build_package_metadata_flow(self, fetcher, mock_deps, tmp_path, mocker):
        ...
        mocker.patch('src.license_hierarchy.analyzer.package_metadata_fetcher.PROJECT_ROOT', tmp_path)

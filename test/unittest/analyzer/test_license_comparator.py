...
def test_init_and_process(mock_scan_engine, pypi_metadata_factory):
...
def test_compare_license_trees_match(mock_scan_engine, pypi_metadata_factory):
...
def test_compare_license_trees_mismatch(mock_scan_engine, pypi_metadata_factory):
...
def test_compare_license_trees_multiple_match(mock_scan_engine, pypi_metadata_factory):
...
def test_compare_license_trees_missing_in_scan(mock_scan_engine, pypi_metadata_factory):
...
def test_compare_license_trees_single_unknown(mock_scan_engine, pypi_metadata_factory):
